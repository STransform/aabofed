...
@Entity
@Table(name = "notice_comment_reactions", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"comment_id", "user_id"})
})
public class NoticeCommentReaction {
    ...
    public NoticeComment getComment() { return comment; }
    public void setComment(NoticeComment comment) { this.comment = comment; }
